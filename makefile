...
build-linux:
	GOOS=linux OS_ARCH=darwin_amd64 GOARCH=amd64 go build -o ${BINARY}

build-darwin:
	GOOS=darwin OS_ARCH=darwin_amd64 GOARCH=amd64 go build -o ${BINARY}

build-darwin-m1:
	GOOS=darwin OS_ARCH=darwin_arm64 GOARCH=arm64 go build -o ${BINARY}
...
install-darwin-m1: build-darwin
