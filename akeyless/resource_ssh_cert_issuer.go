...
func resourceSSHCertIssuerRead(d *schema.ResourceData, m interface{}) error {
	...
	if rOut.AllowedUsers != nil {
		err = d.Set("allowed_users", *rOut.AllowedUsers)
		if err != nil {
			return err
		}
	}
	...
	if rOut.Principals != nil {
		err = d.Set("principals", *rOut.Principals)
		if err != nil {
			return err
		}
	}
	if rOut. .Extensions != nil {
		err = d.Set("extensions", *rOut.Extensions)
		if err != nil {
			return err
		}
	}
