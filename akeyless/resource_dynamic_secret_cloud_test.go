...
func TestDynamicSecretGcp(t *testing.T) {
	...
	config := fmt.Sprintf(`
		resource "akeyless_dynamic_secret_gcp" "%v" {
			name              = "%v"
			gcp_sa_email      = "test@test-project.iam.gserviceaccount.com"
...
func TestDynamicSecretEks(t *testing.T) {
	...
	config := fmt.Sprintf(`
		resource "akeyless_dynamic_secret_eks" "%v" {
			name                  = "%v"
			eks_access_key_id     = "AKIAIOSFODNN7EXAMPLE"
			eks_secret_access_key = "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"
...
func TestDynamicSecretGke(t *testing.T) {
	...
	config := fmt.Sprintf(`
		resource "akeyless_dynamic_secret_gke" "%v" {
			...
			gke_service_account_email = "test@test-project.iam.gserviceaccount.com"
