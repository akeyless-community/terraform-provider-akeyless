...
- `customer_frg_id` (String, Sensitive) Customer fragment ID for DFC keys
...
- `ext_key_usage` (String) A comma-separated list of extended key usage values
...
- `key_usage` (String) A comma-separated list of key usage values
