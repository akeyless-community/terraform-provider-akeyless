...
- `allowed_extra_extensions` (String) A json string containing the allowed extra extensions for the pki cert issuer
...
- `destination_path` (String) A path in which to save generated certificates
