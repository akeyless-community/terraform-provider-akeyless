...
page_title: "akeyless_auth_method_alicloud Resource - terraform-provider-akeyless"
subcategory: ""
description: |-
  AliCloud Auth Method Resource
---

# akeyless_auth_method_alicloud (Resource)
...
- `bound_account_id` (Set of String) A list of AliCloud account-IDs that the access is restricted to
...
- `product_type` (Set of String) Choose the relevant product type for the auth method [sm, sra, pm, dp, ca, ara]
