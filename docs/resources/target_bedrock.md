...
page_title: "akeyless_target_bedrock Resource - terraform-provider-akeyless"
subcategory: ""
description: |-
  Bedrock Target resource
---

# akeyless_target_bedrock (Resource)
...
- `api_key` (String, Sensitive) API key for Bedrock
- `bedrock_url` (String) Base URL of the Bedrock API
