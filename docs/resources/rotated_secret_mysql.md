...
page_title: "akeyless_rotated_secret_mysql Resource - terraform-provider-akeyless"
subcategory: ""
description: |-
  Mysql rotated secret resource
---

# akeyless_rotated_secret_mysql (Resource)
...
- `auto_rotate` (String) Whether to automatically rotate every rotation_interval days, or disable existing automatic rotation
